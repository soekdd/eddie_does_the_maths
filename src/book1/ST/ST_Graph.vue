...
>
	...
	<g>
		<path d="M327.813,540.335L354.33,531.496L345.491,558.013C345.491,549.174 336.652,540.335 327.813,540.335Z" style="fill:var(--graph-ink);"/>
		<path d="M118.109,767.717C118.109,767.717 289.243,596.583 340.188,545.638" style="fill:none;stroke:var(--graph-ink);stroke-width:4.17px;"/>
	</g>
	<g>
		<path d="M1035.319,291.323L1062.989,295.276L1043.229,315.04C1047.179,307.134 1043.229,295.276 1035.319,291.323Z" style="fill:var(--graph-ink);"/>
		<path d="M354.33,531.496C354.33,531.496 931.275,339.181 1044.019,301.6" style="fill:none;stroke:var(--graph-ink);stroke-width:4.17px;"/>
		<Katex as="foreignObject"
			height="50"
			:tex="`\\frac{${model.ndd}}{60}*\\frac{${model.ndd}}{60}+\\frac{${model.dd}}{60}\\left(1+\\frac{${
				model.ndd}}{60}\\right)*\\left(${model.paa}\\%*${model.prr}\\%+${model.pnaa}\\%\\right)`"
			transform="matrix(3,0,0,3,650,134)"
			width="400"
			x="0px"
			y="0px"
		/>
		<Katex as="foreignObject"
			height="50"
			:tex="`\\frac{${model.dd}}{60}\\left(1+ \\frac{${model.ndd}}{60}\\right)*${model.paa}\\%*${model.pnrr}\\%`"
			transform="matrix(3,0,0,3,1093.077407,1155.048375)"
			width="400"
			x="0px"
			y="0px"
		/>
		<Katex as="foreignObject"
			height="50"
			:tex="`\\frac{${model.dd}}{60}`"
			transform="matrix(3,0,0,3,433,652)"
			width="40"
			x="0px"
			y="0px"
		/>
		<Katex as="foreignObject"
			height="50"
			:tex="`\\frac{${model.dd}}{60}`"
			transform="matrix(3,0,0,3,350,800)"
			width="40"
			x="0px"
			y="0px"
		/>
		<Katex as="foreignObject"
			height="50"
			:tex="`\\frac{${model.ndd}}{60}`"
			transform="matrix(3,0,0,3,100,500)"
			width="40"
			x="0px"
			y="0px"
		/>
		<Katex as="foreignObject"
			height="50"
			:tex="`\\frac{${model.ndd}}{60}`"
			transform="matrix(3,0,0,3,600,320)"
			width="40"
			x="0px"
			y="0px"
		/>
		<Katex as="foreignObject"
			height="50"
			:tex="`${model.pnrr}\\%`"
			transform="matrix(3,0,0,3,860,1020)"
			width="40"
			x="0px"
			y="0px"
		/>
		<Katex as="foreignObject"
			height="50"
			:tex="`${model.prr}\\%`"
			transform="matrix(3,0,0,3,820,620)"
			width="40"
			x="0px"
			y="0px"
		/>
		<Katex as="foreignObject"
			height="50"
			:tex="`${model.paa}\\%`"
			transform="matrix(3,0,0,3,620,840)"
			width="40"
			x="0px"
			y="0px"
		/>
		<Katex as="foreignObject"
			height="50"
			:tex="`${model.pnaa}\\%`"
			transform="matrix(3,0,0,3,620,470)"
			width="40"
			x="0px"
			y="0px"
		/>
	...
	<g>
		<path d="M593.412,831.481L590.552,648.105" style="fill:none;stroke:var(--graph-ink);stroke-width:4.16px;"/>
	</g>
	<g>
		<path d="M767.717,177.165L767.717,59.055" style="fill:none;stroke:var(--graph-ink);stroke-width:2.64px;" transform="matrix(2,0,0,1,-472.441,826.772)"/>
	</g>
	<g>
		<path d="M1062.993,477.128L1062.993,240.908" style="fill:none;stroke:var(--graph-ink);stroke-width:4.16px;"/>
	</g>
	<g>
		<path d="M580.868,685.185L593.411,710.163L565.902,705.211C574.65,703.945 582.133,693.933 580.868,685.185Z" style="fill:var(--graph-ink);"/>
		<path d="M354.33,531.496C354.33,531.496 523.827,658.162 577.39,698.191" style="fill:none;stroke:var(--graph-ink);stroke-width:4.17px;"/>
	</g>
	<g>
		<path d="M815.53,867.907L829.632,892.04L801.865,888.842C810.515,887.024 817.348,876.557 815.53,867.907Z" style="fill:var(--graph-ink);"/>
		<path d="M591.936,736.883C591.936,736.883 758.745,845.767 812.885,881.107" style="fill:none;stroke:var(--graph-ink);stroke-width:4.17px;"/>
	</g>
	<g>
		<path d="M1035.71,360.392L1062.99,354.333L1051.47,379.797C1052.38,371.005 1044.5,361.303 1035.71,360.392Z" style="fill:var(--graph-ink);"/>
		<path d="M591.982,736.913C591.982,736.913 966.043,433.08 1047.47,366.942" style="fill:none;stroke:var(--graph-ink);stroke-width:4.17px;"/>
	</g>
	<g>
		<path d="M1156.1,341.831L1181.1,354.331L1156.1,366.831C1162.35,360.581 1162.35,348.081 1156.1,341.831Z" style="fill:var(--graph-ink);"/>
		<path d="M1062.99,354.331L1161.1,354.331" style="fill:none;stroke:var(--graph-ink);stroke-width:4.17px;"/>
	</g>
	<g>
		<path d="M1156.1,932.382L1181.1,944.882L1156.1,957.382C1162.35,951.132 1162.35,938.632 1156.1,932.382Z" style="fill:var(--graph-ink);"/>
		<path d="M1062.99,944.882L1161.1,944.882" style="fill:none;stroke:var(--graph-ink);stroke-width:4.17px;"/>
	</g>
	<g>
		<path d="M1041.43,927.097L1062.99,944.884L1035.83,951.46C1043.32,946.771 1046.12,934.589 1041.43,927.097Z" style="fill:var(--graph-ink);"/>
		<path d="M826.772,890.534C826.772,890.534 986.942,927.386 1043.5,940.399" style="fill:none;stroke:var(--graph-ink);stroke-width:4.17px;"/>
	</g>
	<g>
		<path d="M1040.56,439.486L1062.99,422.806L1062.88,450.757C1060.12,442.36 1048.96,436.725 1040.56,439.486Z" style="fill:var(--graph-ink);"/>
		<path d="M826.772,890.534C826.772,890.534 1010.75,526.257 1053.98,440.658" style="fill:none;stroke:var(--graph-ink);stroke-width:4.17px;"/>
	</g>
	<g>
		<path d="M568.535,759.679L593.41,772.426L568.287,784.677C574.599,778.49 574.723,765.99 568.535,759.679Z" style="fill:var(--graph-ink);"/>
		<path d="M118.109,767.717C118.109,767.717 483.148,771.333 573.411,772.227" style="fill:none;stroke:var(--graph-ink);stroke-width:4.17px;"/>
	</g>
	<g>
		<path d="M1370.348,311.58C1352.502,311.58 1337.983,326.1 1337.983,343.946C1337.983,361.792 1352.502,376.312 1370.348,376.312C1388.195,376.312 1402.714,361.792 1402.714,343.946C1402.714,326.1 1388.195,311.58 1370.348,311.58ZM1370.348,371.277C1355.279,371.277 1343.018,359.016 1343.018,343.946C1343.018,328.875 1355.279,316.614 1370.348,316.614C1385.42,316.614 1397.679,328.875 1397.679,343.946C1397.679,359.016 1385.42,371.277 1370.348,371.277Z" style="fill-rule:nonzero;fill:var(--graph-ink);"/>
